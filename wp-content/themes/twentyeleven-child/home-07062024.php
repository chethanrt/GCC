...
if ($counterData->have_posts()) {
  while ($counterData->have_posts()) {
    ...
    $institutionCount = get_post_meta(get_the_ID(), 'number_of_institutions', true);
  }
  // Reset post data
  wp_reset_postdata();
}
...
?> 
      ...
      <!-- code added for counter ui - arun -->
...
$climage = get_field('cl_image');
 ...
 <!-- code added for counter functionality - arun -->
