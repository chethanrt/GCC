    ...
    <div id="content" role="main">
        ...
        while (have_posts()):
            ...
            <section class="pr-02">
                ...
                <div class="container effort">
                    <div class="row effort-row">
                        <div class="col-md-6 col-sm-12 col-xs-12 wace2 p-0">
                           <!--  <img src="https://themonkplatform.iplatformsolutions.com/wp-content/uploads/2023/11/Banners_800x819_ALS-1.jpg"
                                class="img-fluid" alt=""> -->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 wace2 ai-hub-mobi-hide">
            ...
            <section class="m-mbg ai-hub-desk-hide">
                <div class="container effort" style="margin-top:6%">
                    <div class="row effort-row">
                        <div class="col-md-5 col-sm-12 col-xs-12 ">
                            <h3 style="text-align: center; font-size: 34px !important;"><span class="anim">AI Accelerators</span></h3>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 ">
                            <p style="width:100%; text-align: center">The AI accelerators empower intellectual property owners and content creators by enhancing speed, efficiency, and cost-effectiveness in content generation, transformation, and retrieval.</p>
                        </div>
                    </div>
                </div>
            </section>
